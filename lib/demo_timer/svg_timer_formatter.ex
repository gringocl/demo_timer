defmodule DemoTimer.SvgTimerFormatter do
  def format_perc(%{duration: duration, time_passed: time_passed}) do
    "#{calc_perc_dividend(duration, time_passed)}%"
  end

  def format_partial_stroke_dash_array(
        %{duration: duration, time_passed: time_passed},
        full_dash_array
      ) do
    perc_complete = calc_perc_dividend(duration, time_passed) / 100
  ...
  defp calc_perc_dividend(0, 0), do: 100

  defp calc_perc_dividend(duration, time_passed) do
